...
//        log.info(String.format("Processing file %s with TransferItem %s", path.toString(), (Object)transferItem));
//
...
//        moveFileToOutbox(transferItem, path, this.outbox);
    ...
    DepositProperties createOrGetTransferItem(Path path) throws InvalidTransferItemException {
        return new DepositProperties();
